...
namespace ElementalLudo.Board
{
    ...
    public sealed class LudoBoardDepthRenderer : MonoBehaviour
    {
        ...
        [SerializeField] private bool showHomeDiscs;

        /// <summary>Switches the corners between classic discs and biome plates.</summary>
        public void SetShowHomeDiscs(bool value)
        {
            if (showHomeDiscs == value)
            {
                return;
            }
